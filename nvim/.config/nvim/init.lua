...
require('lazy').setup({
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      --        For example, to see the options for `lua_ls`, you could gojj to: https://luals.github.io/wiki/settings/
      local servers = {
        clangd = {},
        -- gopls = {},
        pyright = {},
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      format_on_save = function(bufnr)
        ...
        local disable_filetypes = { c = true, cpp = true, mysql = true, sqlite = true, sql = true }
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'markdown', 'markdown_inline', 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'query', 'vim', 'vimdoc', 'sql' },
  ...
  require 'kickstart.plugins.markdownprev',
